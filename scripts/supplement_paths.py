"""Path resolution for the supplementary-analysis scripts. Set the environment variables:
  ...
  UHI_AIR_COMPANION   the companion city panels (Zenodo 10.5281/zenodo.22108287)
...
The extra inputs (GEE extractions, MTUC subset, crosswalks, seasonal panels) ship with
...
EXTRA = _env("UHI_EXTRA_INPUTS", COMP)   # the companion record ships the extra inputs
