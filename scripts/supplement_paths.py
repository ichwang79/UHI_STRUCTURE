"""Path resolution for the supplementary-analysis scripts. Set the environment variables:
  ...
  UHI_AIR_COMPANION   the companion city panels (Zenodo 10.5281/zenodo.22108287, v3 or later)
...
EXTRA = _env("UHI_EXTRA_INPUTS", COMP)   # the version-3 companion record ships the extra inputs
